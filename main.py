...
if __name__ == '__main__':
    ...
    parameters = {'ma_period': [25], 'avg_period': [25], 'std_period': 25, 'multiplier': [2],
                  'a': 1, 'b': 1, 'c': 1, 'd': 1, 'x': 2, 'y': 2}
    file_path = "Binance_BNBUSDT_1h_2018-01-01 00-00-00_2022-07-31 23-00-00.csv"
